...
export const UpdateUserCompany = (myClient) =>
  new CustomStore({
    key: "UNIQUEID",
    load: (loadOptions) => {
      let params = "?";
      ...
      const url = `${process.env.REACT_APP_BASE_URL}/ReturnUserCompany`;
    ...
    insert: (values) => {
      ...
      const url = `${process.env.REACT_APP_BASE_URL}/UpdateUserCompany`;
      return fetch(url, requestoptions) // Request fish
        .then((response) => {
          if (!response.ok) {
            return {
